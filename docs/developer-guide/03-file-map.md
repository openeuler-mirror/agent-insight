...
| `ingest/adapters/{registry,types,opencode,claude,codeagent,openclaw,hermes,trae,langfuse-langgraph}.ts` | ingest | `getAdapter`、`resolveFrameworkId`、`listFrameworks`；`FrameworkAdapter`、`FrameworkDescriptor` |
