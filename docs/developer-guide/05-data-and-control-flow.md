...
flowchart LR
    ...
    download --> runtime["按 Catalog 准备并缓存\nBenchmark Runtime"]
    runtime --> entrypoint["统一 evaluator doctor/evaluate\n文件输入输出契约"]
