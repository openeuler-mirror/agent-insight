...
| **Skill 归因** | 缺陷更可能归属的 Skill 或提示词约束 |
| **改进建议** | 可直接落地的修正动作，如补充 `SKILL.md` 约束 |
...
6. 看 **Skill 归因** 与 **改进建议**，将问题转化为修复动作。
...
- **重新跑归因评估**：调整 Skill 或规则后，用于复核归因结果是否回升。
...
6. 修改 Skill 后点击 **重新跑归因评估**,验证归因分值是否回升。
