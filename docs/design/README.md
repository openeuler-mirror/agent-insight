...
| Agent RAS 故障域插件化（detectors/review/recovery） | [`../agent-ras/designs/features/fault-domain-plugins.md`](../agent-ras/designs/features/fault-domain-plugins.md) | P0/P1 ✅；P2：三平级 PLUGIN 扫描；review 独立模块；设计 v0.8 | Refactor / Feature | 2026-08-06 | 🟡 部分实现（P2 未开始） | — |
