...
- [Agent 测评闭环第一版](evaluation-harness-v1/phase1-需求分析.md)：版本化多轮 Case、规则/LLM 评估、真实执行与 Trace、静态分析及回归闭环；refactor-for-nh 演示收敛已完成四资产版本/对比和真实 HTTP 验证，浏览器核心闭环已于 2026-09-09 跑通，真实模型生成及公共/私有语义评分也已验收（第一阶段演示完成，后续增强见矩阵）。
