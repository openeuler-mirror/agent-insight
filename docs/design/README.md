...
| Agent RAS 故障域自包含插件化 | [`../agent-ras/designs/features/fault-domain-plugins.md`](../agent-ras/designs/features/fault-domain-plugins.md) | P0/P1 ✅；P2：`fault_domains/<id>/`+PLUGIN 扫描、动态 kind/config、迁内置域（无 manifest）；设计 v0.3 | Refactor / Feature | 2026-08-06 | 🟡 部分实现（P2 未开始） | — |
