...
function generateBashScript(host: string, baseUrl: string, apiKey: string, noninteractive: boolean = false, frameworks: string = 'opencode', nokey: boolean = false): string {
    const lines = [
        ...
        'if [ "$INSTALL_OPENCODE" = "false" ] && [ "$INSTALL_CLAUDE" = "false" ] && [ "$INSTALL_HERMES" = "false" ] && [ "$INSTALL_JIUWEN" = "false" ]; then',
...
function generatePowerShellScript(host: string, baseUrl: string, apiKey: string, noninteractive: boolean = false, frameworks: string = 'opencode', nokey: boolean = false): string {
    const lines = [
        ...
        '',
        '# Exit if nothing selected',
        'if (-not $INSTALL_OPENCODE -and -not $INSTALL_CLAUDE -and -not $INSTALL_HERMES -and -not $INSTALL_JIUWEN) {',
        ...
        'Add-Content $AGENT_INSIGHT_CONFIG_FILE "AGENT_INSIGHT_CLIENT_KEY_HASH=$CLIENT_KEY_HASH"',
        'Add-Content $AGENT_INSIGHT_CONFIG_FILE "AGENT_INSIGHT_OPENCODE_SPOOL_DIR=$homeDir\\.agent-insight\\otel_data\\opencode\\$CLIENT_KEY_HASH"',
        'Add-Content $AGENT_INSIGHT_CONFIG_FILE "AGENT_INSIGHT_OPENCODE_CHECKPOINT=$homeDir\\.agent-insight\\opencode_uploader_checkpoint_$CLIENT_KEY_HASH.json"',
        'Add-Content $AGENT_INSIGHT_CONFIG_FILE "AGENT_INSIGHT_OPENCODE_UPLOAD_SINCE_MS=$UPLOAD_SINCE_MS"',
