...
function generateBashScript(
    ...
    const lines = [
        ...
        '    pkg_tmp_root="$HOME/.agent-insight/client/tmp"',
        ...
        'if [[ "$SELECTED_FRAMEWORKS" == *"goal-plus"* ]]; then echo "     Optional semantic enrichment: goal-plus-collector attach /absolute/path/to/workspace/.gp && goal-plus-collector scan && goal-plus-collector start"; fi',
