...
function generateBashScript(host: string, baseUrl: string, apiKey: string): string {
    const lines = [
        ...
        'if curl -sSf "$SKILL_INSIGHT_BASE_URL/api/setup/example-messages" -o "$HOME/.agent-insight/example/messages"; then',
...
function generatePowerShellScript(host: string, baseUrl: string, apiKey: string): string {
    const lines = [
        ...
        '    Invoke-WebRequest -Uri "$SKILL_INSIGHT_BASE_URL/api/setup/opencode-uploader" -OutFile (Join-Path $homeDir ".agent-insight\\opencode_uploader_client.js")',
        ...
        'Add-Content $SKILL_INSIGHT_CONFIG_FILE "SKILL_INSIGHT_OPENCODE_SPOOL_DIR=$homeDir\\.agent-insight\\otel_data\\opencode"',
        'Add-Content $SKILL_INSIGHT_CONFIG_FILE "SKILL_INSIGHT_OPENCODE_UPLOADER=$homeDir\\.agent-insight\\opencode_uploader_client.js"',
        'Add-Content $SKILL_INSIGHT_CONFIG_FILE "SKILL_INSIGHT_CLAUDE_OTEL_SPOOL_DIR=$homeDir\\.agent-insight\\otel_data\\claude"',
