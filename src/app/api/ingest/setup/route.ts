...
function generateBashScript(host: string, baseUrl: string, apiKey: string, preselected: { value: string; label: string }[]): string {
    const lines = [
        ...
        '            node "$HOME/.agent-insight/claude_context_uploader.js" --install-hook || echo "⚠️  注册 SessionEnd hook 失败,可稍后手动执行:node $HOME/.agent-insight/claude_context_uploader.js --install-hook"',
        '        else',
...
function generatePowerShellScript(host: string, baseUrl: string, apiKey: string, preselected: { value: string; label: string }[]): string {
    const lines = [
        ...
        '    $claudeContextUploader = "$homeDir\\.agent-insight\\claude_context_uploader.js"',
        '    try {',
