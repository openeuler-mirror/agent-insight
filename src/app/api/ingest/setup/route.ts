...
function generateBashScript(host: string, baseUrl: string, apiKey: string, preselected: { value: string; label: string }[]): string {
    ...
    const lines = [
        ...
        'if [ "$LLAMAINDEX_READY" = "true" ]; then echo "  6. Restart terminal, activate the project environment, then run: python -m agent_insight_llamaindex.cli run -- python app.py"; fi',
        'echo "------------------------------------------------"',
    ];
    return lines.join('\n');
}
...
function generatePowerShellScript(host: string, baseUrl: string, apiKey: string, preselected: { value: string; label: string }[]): string {
    ...
    const lines = [
        ...
        'if ($LLAMAINDEX_READY) { Write-Host "  6. Restart PowerShell, activate the project environment, then run: python -m agent_insight_llamaindex.cli run -- python app.py" }',
        'Write-Host "------------------------------------------------"',
    ];
    return lines.join('\n');
}
