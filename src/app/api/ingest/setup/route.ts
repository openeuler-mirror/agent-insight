...
function generateBashScript(host: string, baseUrl: string, apiKey: string, packageSpec: string): string {
    const lines = [
        ...
        'if [ "$INSTALL_OPENCODE" = "false" ] && [ "$INSTALL_CLAUDE" = "false" ] && [ "$INSTALL_OPENCLAW" = "false" ] && [ "$INSTALL_XIAOO" = "false" ]; then',
...
function generatePowerShellScript(host: string, baseUrl: string, apiKey: string, packageSpec: string): string {
    const lines = [
        ...
        '',
        '# Exit if nothing selected',
        'if (-not $INSTALL_OPENCODE -and -not $INSTALL_CLAUDE -and -not $INSTALL_OPENCLAW -and -not $INSTALL_XIAOO) {',
        ...
        '',
        'if ($INSTALL_OPENCODE -or $INSTALL_XIAOO) {',
