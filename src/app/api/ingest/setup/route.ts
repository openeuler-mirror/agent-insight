...
function generateBashScript(host: string, baseUrl: string, apiKey: string): string {
    const lines = [
        ...
        'if [ "$INSTALL_CODEAGENT" = "true" ]; then echo "  3. Restart terminal, then run: codeagent_insight"; fi',
...
function generatePowerShellScript(host: string, baseUrl: string, apiKey: string): string {
    const lines = [
        ...
        'if ($INSTALL_CODEAGENT) { Write-Host "  3. Restart PowerShell, then run: codeagent-insight" }',
