...
function strings(locale: string) {
  ...
  if (zh) {
    return {
      title: '版本管理',
      subtitle: '通过标签管理版本分组和业务分类',
      intro: '通过标签实现版本管理：版本标签用于版本分析的对比与详情；业务标签用于标记 Trace 的业务分类。',
      newTag: '新建标签',
      newVersion: '新建版本标签',
      newBusiness: '新建业务标签',
      version: '版本标签',
      ...
      editImpact: '影响范围：名称、说明、颜色和类型变化会同步影响链路追踪和版本分析中的展示；已绑定的 Trace 不会丢失。',
      name: '名称',
      description: '描述',
      type: '标签类型',
      color: '颜色',
      ...
      deleteImpactBusiness: '业务标签删除后，Trace 上对应的业务分类标记将移除。',
      confirmDelete: '删除',
    };
  }
  return {
    title: 'Version Management',
    subtitle: 'Manage version cohorts and business categories',
    intro: 'Version tags power Version Analysis; business tags label the business category of traces.',
    newTag: 'New tag',
    ...
    businessHint: 'Used to label the business category of traces',
    traceCount: 'Traces',
    tagCount: 'Tags',
    ungrouped: 'Ungrouped',
    ...
    editImpact: 'Impact: name, description, color, and type changes are reflected in Trace and Version Analysis. Bound traces are kept.',
    name: 'Name',
    ...
    deleteImpactBusiness: 'Deleting a business tag removes its business category label from bound traces.',
