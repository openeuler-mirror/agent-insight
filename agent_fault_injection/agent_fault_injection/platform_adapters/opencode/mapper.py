...
from ...models import RunArtifacts, RunRequest
...
class OpenCodeTrajectoryMapper:
    ...
    def map(
        ...
        from ...evaluation import ExecutionEvidenceBuilder

        ExecutionEvidenceBuilder().write_opencode_execution_file(artifacts)
